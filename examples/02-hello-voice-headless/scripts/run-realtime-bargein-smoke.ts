...
//
// Live acceptance gate for WBS-3: barge-in mid-response — assistant audio stops
// promptly and a subsequent turn is still audible.
...
const OUTPUT_DIR = join(PKG_ROOT, "test", "performance", "runs", "realtime-bargein-smoke");
