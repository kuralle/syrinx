...
| G6 | **Function-call interruption contract unenforced** — dangling tool calls when barge-in aborts mid-call | reasoning | Med | Low-Med | tied to G2; `voice-bridge-aisdk` | **P2** |
